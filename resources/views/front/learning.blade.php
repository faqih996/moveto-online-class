        ...
        <div class="relative flex gap-5 video-player flex-nowrap">
            ...
            <div
                ...
                @forelse($course->course_videos as $video)
                    @php
                        $currentVideoId = Route::current()->parameter('currentVideoId');
                    ...
                    <div class="flex flex-col gap-3">
                        <div
                            ...
                            <a href="{{ route('front.learning', [$course, 'courseVideoId' => $video->id]) }}">
                                <p
                                    class="font-semibold transition-all duration-300 group-hover:text-white {{ $isActive ? 'text-white' : 'text-black' }}">
                                    {{ $video->name }}
                                </p>
                            </a>
                        </div>
