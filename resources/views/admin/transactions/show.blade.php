                ...
                <div class="flex flex-row gap-x-10">
                    ...
                    <div class="flex flex-col gap-y-10">
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-indigo-950">Rp {{ $subscribeTransaction->total_amount }}
                            </h3>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <h3 class="text-xl font-bold text-indigo-950">
                                {{ $subscribeTransaction->subscribe_start_date }}</h3>
                        </div>
                        <div>
                            <p class="mb-2 text-sm text-slate-500">Status</p>
                            @if ($subscribeTransaction->is_paid)
                                <span class="px-3 py-2 text-white bg-green-500 rounded-full w-fit">
                                    Active
                                </span>
                            @else
                                <span class="px-3 py-2 text-white bg-orange-500 rounded-full w-fit">
                                    Pending
                                </span>
                            @endif
                        </div>
